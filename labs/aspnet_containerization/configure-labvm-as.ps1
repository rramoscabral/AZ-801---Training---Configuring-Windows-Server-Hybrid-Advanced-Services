...
Invoke-WebRequest 'https://github.com/rramoscabral/AZ-801---Training---Configuring-Windows-Server-Hybrid-Advanced-Services/raw/main/labs/aspnet_containerization/MicrosoftEdgeEnterpriseX64.msi' -OutFile 'C:\MicrosoftEdgeEnterpriseX64.msi'
$msiArgs = @(
    "/i"
...
Invoke-WebRequest 'https://github.com/rramoscabral/AZ-801---Training---Configuring-Windows-Server-Hybrid-Advanced-Services/raw/main/labs/aspnet_containerization/WebDeploy_amd64_en-US.msi' -OutFile 'C:\MicrosoftWebDeploy.msi'
$msiArgs = @(
    "/i"
...
Invoke-WebRequest 'https://raw.githubusercontent.com/rramoscabral/AZ-801---Training---Configuring-Windows-Server-Hybrid-Advanced-Services/main/labs/aspnet_containerization/parts.zip' -OutFile 'D:\parts.zip'
